...
public class ContaPessoaJuridica extends Conta{
	...
	public ContaPessoaJuridica(int numero, int agencia, double saldo, String titular) {
	...
	void sacar(double valor) {
		...
		if (valor <= 0) {
			...
			novoSaldo = (getSaldo() - valor) - 1.50;
			setSaldo(novoSaldo);

			System.out.printf("R$%.2f" + "foram sacados da sua conta", valor);
	...
	void calcularTarifaMensal() {
		...
		setSaldo(novoSaldo);
		System.out.println("Foi descontado um Valor mensal fixo de R$20,00");
	}
